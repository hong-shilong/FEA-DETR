...
from .GLU import SelectGlu, Attention
...
class RTDETRTransformerv2(nn.Module):
    ...
    def __init__(self,
        ...
        self.SelectGlu = SelectGlu(256)
        # self.SelectGlu = Attention(dim=256, num_heads=8, bias=True)
        self._reset_parameters()
    ...
    def _get_encoder_input(self, feats: List[torch.Tensor]):
        ...
        # proj_feats = [self.input_proj[i](self.SelectGlu(feat)) for i, feat in enumerate(feats)]
